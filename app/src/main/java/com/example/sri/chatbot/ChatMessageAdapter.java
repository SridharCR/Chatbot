...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage>
{
    ...
    public int getItemViewType(int position) {
        ...
        if (item.getIsMine() && !item.getIsImage()) return MY_MESSAGE;
        else if (!item.getIsMine() && !item.getIsImage()) return OTHER_MESSAGE;
        else if (item.getIsMine() && item.getIsImage()) return MY_IMAGE;
